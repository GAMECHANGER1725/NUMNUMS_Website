...
// STORES and BUSINESS live in catalog.mjs, which has no imports, so the public
// site's receipt function can print the same seller identity the ops invoice
// does. One copy of the ABN, not two that can drift.
import { STORES, BUSINESS } from './catalog.mjs';
export { STORES, BUSINESS };
