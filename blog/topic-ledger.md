...
| Halal cakes | `halal-friendly-cakes-eggless-sydney` | 481 | 2 | 25% | **DONE 2026-09-24** — verified live via GSC (90d page+query pull) that the homepage still genuinely outranks/competes with the owner for every halal query (e.g. "halal bakery sydney" 96 impr: homepage pos 43.2 vs owner pos 18.7; "halal cake shop sydney" 82 impr: homepage pos 52.4 vs owner pos 24.4; "halal cakes sydney" 63 impr: homepage pos 54.5 vs owner pos 20.7), caused by the homepage's own FAQPage schema entry mentioning "halal-friendly". FAQ + FAQPage schema already existed on the owner (added in an earlier pass) so that part of the original action was already done. Retitled `<title>`/meta/OG/twitter/JSON-LD headline + H1 from generic "Why Eggless Is a Great Choice" framing to commercial "Halal Cakes Sydney" framing matching the query, and bumped `dateModified`. Added the highest-leverage missing piece: internal links from the two homepage mentions of "halal-friendly" (the Why-Choose-Us feature text and the homepage FAQ answer — both in the visible body, not just schema) to the owner page, anchored on the exact phrase "halal-friendly". |
